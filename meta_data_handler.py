...
class MetaDataHandler:
    ...
    def get(self, lang: str):
        ...
        country_code_index_map = {
            country["country"]: i for i, country in enumerate(countries)
        }
        for country_code in stats:
            countries[country_code_index_map[country_code]]["stats"] = stats[
                country_code
            ]
            countries[country_code_index_map[country_code]]["sources"] = sources[
                country_code
            ]
